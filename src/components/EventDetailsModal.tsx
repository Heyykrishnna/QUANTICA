        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-hidden">
          ...
          >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-4">
                    {event.groups.map((group, index) => (
                      <button
                        ...
                        className={`px-4 py-3 rounded-md border-2 ${colorClass} bg-card/50 backdrop-blur-sm text-foreground font-bold text-center transition-all hover:scale-105 ${selectedGroup === group ? 'ring-2 ring-offset-2 ring-offset-background ' + (event.color === "cyan" ? "ring-cyan" : "ring-magenta") : ''
                          }`}
                      >
                        {group}
                      </button>
            ...
            <div className="p-6 pt-0">
              <button
                onClick={onClose}
                className={`w-full py-3 px-6 rounded-lg font-bold uppercase tracking-wider transition-all duration-300 ${event.color === "cyan"
